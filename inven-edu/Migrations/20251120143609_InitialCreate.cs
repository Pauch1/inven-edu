...
namespace inven_edu.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssuanceRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IssuanceRecords_InventoryItems_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssuanceRecords_IssuedDate",
                table: "IssuanceRecords",
                column: "IssuedDate");

            migrationBuilder.CreateIndex(
                name: "IX_IssuanceRecords_ItemId",
                table: "IssuanceRecords",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuanceRecords_Status",
                table: "IssuanceRecords",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_IssuanceRecords_UserId",
                table: "IssuanceRecords",
                column: "UserId");
        }
